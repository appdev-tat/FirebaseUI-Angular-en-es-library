This is a fork of the FirebaseUI-Angular library. It is an Angularized version of [firebaseui-web-en-es](https://github.com/appdev-tat/firebaseui-web-en-es).
...
<firebase-ui-es
    ...
    (signInFailure)="errorCallback($event)"></firebase-ui-es>
```
